...
public class Login extends JFrame{
	...
	public Login() {
		...
		JLabel labelPassword=new JLabel("Lozinka: ");
		...
		JButton logintipka=new JButton("Prijava");
	...
	public boolean Provjera(String korisnik,String password) {
		...
		e.printStackTrace();
		JOptionPane.showMessageDialog(this, "Greška u povezivanju s bazom", "Greška",JOptionPane.ERROR_MESSAGE);
		return false;
		}
	...
	public boolean testDBConnection() {
	    ...
	    try (Connection conn = DBConnection.getConnection();
	        ...
	        e.printStackTrace();
	        JOptionPane.showMessageDialog(null, "Greška u povezivanju s bazom","Greška",JOptionPane.ERROR_MESSAGE);
	        return false;  
	    }
	}
}