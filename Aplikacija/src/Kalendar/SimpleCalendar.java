...
public class SimpleCalendar extends JFrame { // Definicija klase koja nasljeđuje JFrame
    ...
    private void showTimeSelection(int day) {
        ...
        ArrayList<String> timeSlots=new ArrayList<>(); //lista za time slotove
        ...
        for (int hour = 7; hour <= 21; hour++) {
            ...
            clientField.addActionListener(new ActionListener() { //dodaje ili oduzima time slotove kako se klikne clientField
        ...
        confirmButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	if(timeSlots.isEmpty()) {
            		JOptionPane.showMessageDialog(timePanel, "Niste odabrali nijedan termin!");  
            	}
            	else {
                ...
                if (response == JOptionPane.YES_OPTION) { //svaki timeslot u listi se sprema u bazu za taj dan
                    for (String timeSlot : timeSlots) {
						saveAppointments(day,timeSlot);
				}
                    JOptionPane.showMessageDialog(timePanel, "Podaci su spremljeni!");
                    timeFrame.dispose();
